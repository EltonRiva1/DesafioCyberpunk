 ...
 */
package br.edu.solutis.clones.util;
...
public class FabricaConexao {
    ...
    private static final String URL_CONEXAO = "jdbc:mysql://localhost/desafio-cyberpunk", USUARIO = "root", SENHA = "";
    //private static final String URL_CONEXAO = "jdbc:mysql://cyberpunk.mysql.uhserver.com/cyberpunk", USUARIO = "cyberpunk1", SENHA = "desafio@1";
